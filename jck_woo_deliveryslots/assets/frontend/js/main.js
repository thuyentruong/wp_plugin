(function($, document) {
    ...
    var jckwds = {
        ...
        cache: function() {
            ...
            jckwds.vars.selected_shipping_method          = false;
        ...
        watch_update_checkout: function() {
            ...
            jckwds.els.document_body.on( 'updated_checkout', function(){
                ...
                var selected_shipping_method = jckwds.get_selected_shipping_method();

                /**
                 * If shipping method has changed
                 */

                if( selected_shipping_method === jckwds.vars.selected_shipping_method ) { return; }

                /**
                 * Re-cache the selected shipping method
                 */

                jckwds.vars.selected_shipping_method = selected_shipping_method;
        ...
        refresh_datepicker: function( callback ) {
            ...
            bookable_dates_data = {
                ...
                selected_shipping_method: jckwds.vars.selected_shipping_method
            };
        ...
        clear_date_time_fields: function() {
            ...
            jckwds.els.timeslot_select.find('option:first-child').attr("selected", "selected");
        ...
        get_selected_shipping_method: function() {
            ...
            return typeof shipping_methods[0] !== "undefined" ? shipping_methods[0] : false;
